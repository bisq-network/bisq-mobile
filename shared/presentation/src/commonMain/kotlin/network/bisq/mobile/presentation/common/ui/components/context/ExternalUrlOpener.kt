 ...
 * ([MainPresenter.navigateToUrl] → [network.bisq.mobile.data.utils.UrlLauncher]).
 * On failure, [MainPresenter.navigateToUrl] shows the standard cannot-open-URL snackbar once.
 */
...
fun MainPresenter.asExternalUrlOpener(): ExternalUrlOpener = ExternalUrlOpener { url -> navigateToUrl(url) }
