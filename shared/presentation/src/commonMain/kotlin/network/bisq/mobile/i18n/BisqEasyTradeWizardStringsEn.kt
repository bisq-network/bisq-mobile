...
val EnBisqEasyTradeWizardStrings = BisqEasyTradeWizardStrings(
    ...
    bisqEasy_tradeWizard_review_paymentMethodDescription_btc = "Bitcoin settlement method",
    ...
    bisqEasy_tradeWizard_review_paymentMethodDescription_fiat = "Fiat payment method",
    ...
    bisqEasy_tradeWizard_review_priceDetails_float = "Float price. {0} {1} market price of {2}",
