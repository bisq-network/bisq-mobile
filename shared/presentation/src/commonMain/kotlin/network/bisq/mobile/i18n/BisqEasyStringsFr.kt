...
val FrBisqEasyStrings = BisqEasyStrings(
    ...
    bisqEasy_takeOffer_amount_description = "[FR] The offer allows you can choose a trade amount\n between {0} and {1}",
    ...
    bisqEasy_takeOffer_paymentMethods_subtitle_fiat_buyer = "[FR] Choose a payment method to transfer {0}",
    bisqEasy_takeOffer_paymentMethods_subtitle_fiat_seller = "[FR] Choose a payment method to receive {0}",
