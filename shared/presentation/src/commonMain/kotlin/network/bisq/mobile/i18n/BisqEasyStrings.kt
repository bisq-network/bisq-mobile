...
data class BisqEasyStrings(
    ...
    val bisqEasy_takeOffer_amount_description: String,
    ...
    val bisqEasy_takeOffer_paymentMethods_subtitle_fiat_buyer: String,
    val bisqEasy_takeOffer_paymentMethods_subtitle_fiat_seller: String,
