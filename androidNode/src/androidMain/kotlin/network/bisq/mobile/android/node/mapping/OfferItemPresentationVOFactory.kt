...
object OfferItemPresentationVOFactory {
    fun create(
        ...
        check(optionalAuthorUserProfile.isPresent) { "authorUserProfile for $authorUserProfileId not found. We drop that offer." }
        val authorUserProfile = Mappings.UserProfileMapping.fromBisq2Model(optionalAuthorUserProfile.get())
